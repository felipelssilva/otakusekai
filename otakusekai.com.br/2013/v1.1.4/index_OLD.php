...
<div class="escopo" align="center">
  ...
  <div id="blocoDestaques" align="left"> <a class="faixa" href="#" title="">
        ...
        <ul>
          ...
          <li> <a href="?go=Atracoes&acao=Atracoes%2FRicardoCruz">
            <div id="img"> <img src="Fotos/ricardo-cruz.jpg" width="590" height="350" id="i" /> </div>
          ...
          <li> <a href="?go=Atracoes&acao=Atracoes%2FRicardoJunior">
            <div id="img"> <img src="Fotos/ricardo-junior2.jpg" name="i" width="590" height="350" id="i" /> </div>
          ...
          <li> <a href="?go=Atracoes&acao=Atracoes%2FCanalNostalgia">
            <div id="img"> <img src="Fotos/nostalgia.jpg" name="i" width="590" height="350" id="i" /> </div>
            
          <div class="fundo">
              <p> <strong>Canal Nostalgia</strong></p>
  ...
  <!-- MENU -->
            ...
            <li id="first">Atra&ccedil;&otilde;es</li>
                ...
                <li><a href="?go=Atracoes&acao=Atracoes%2FExameHunter#menuv">Exame Hunter</a> </li> 
				
				<? /*<div id="cadeado"><img src="Fotos/porta-chaves-cadeado-042.png" width="17" height="24"></div>*/ ?>
