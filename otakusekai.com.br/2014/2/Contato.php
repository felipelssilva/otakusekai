...
<form name="form1" method="post" action="?p=Contato&acao=enviar">
  <table width="100%" border="0" align="center">
    <tr>
      <th align="left">Nome: *</th>
      <td><input name="nome" type="text" id="nome" size="20" required="required" /></td>
    </tr>
    <tr>
      <th align="left">E-mail: *</th>
      <td><input name="email" type="text" id="email" size="20"  required="required" /></td>
    </tr>
    <tr>
      <th align="left">Assunto: *</th>
      <td><input name="assunto" type="text" id="assunto" size="20" required="required" /></td>
    </tr>
    <tr>
      <th align="left" valign="top">Mensagem: *</th>
      <td><textarea name="mensagem" cols="50" rows="8" id="mensagem" required="required"></textarea></td>
    </tr>
    <tr>
...
if ($_GET['acao'] == 'enviar'){
	...
	if (empty($nome) || empty($email) || empty($assunto) || empty($mensagem)){ 
		...
		echo "<script>alert('Obrigado por entrar em contato conosco.'); location='?'</script>";
